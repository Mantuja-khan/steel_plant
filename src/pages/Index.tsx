...
const heroImages = [thirdimg1, roofing5, chaukhat1];
const sliderImages = [
  thirdimg1,
  thirdimg2,
  chaukhat1,
    ...
    <>
      ...
      <section className="bg-accent">
        <div className="container mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <ScrollFadeIn>
            <img src={home2} alt="Company building" loading="lazy" width={640} height={360} className="rounded-lg w-full h-90 object-cover shadow-lg" />
          </ScrollFadeIn>
      ...
      <section className="section-padding">
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <ScrollFadeIn>
            <div>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-heading mb-4 uppercase">Our Application</h2>
